...
if model_name=='GradientBoosting':
    model_gb=pickle.load(open('final_model_gb', 'rb'))
    st.success('You selected {} model'.format(model_name))
    
elif model_name=='KNN':
    model_knn=pickle.load(open('final_model_knn', 'rb'))
    st.success('You selected {} model'.format(model_name))
    
else:
    model_rf=pickle.load(open('final_model_rf', 'rb'))
    st.success('You selected {} model'.format(model_name))
...
if st.button("Predict"):
    if model_name=='GradientBoosting':
        scaler=pickle.load(open('scaler_stan','rb'))
        ...
        scaler=pickle.load(open('scaler_min','rb'))
        df=scaler.transform(df)
